...
class TestConfigLoaderLoadRawConfig:
    """测试 ConfigLoader._load_raw_config 方法"""
    ...
    def test_load_yaml_config(self):
        ...
        with patch('builtins.open', mock_open(read_data=yaml.dump(config_data))):
            with patch('os.path.exists') as mock_exists:
                ...
                result = loader._load_raw_config()
...
class TestConfigLoaderLoadSettings:
    """测试 ConfigLoader.load_settings 方法"""
    ...
    def test_load_settings_missing_settings_key(self):
        """测试配置缺少 settings 键"""
        config_data = {'openrouter': {'models': ['model1']}}
